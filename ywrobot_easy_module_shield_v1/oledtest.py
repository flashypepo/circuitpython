...
_OLED_HEIGTH = const(32)
oled = ssd1306.SSD1306_I2C(_OLED_WIDTH, _OLED_HEIGTH, i2c)
...
def corners(oled):
    ...
    oled.pixel(0, 0, 1)
    oled.pixel(0, _OLED_HEIGTH - 1, 1)
    oled.pixel(_OLED_WIDTH - 1, 0, 1)
    oled.pixel(_OLED_WIDTH - 1, _OLED_HEIGTH - 1, 1)
    oled.show()
