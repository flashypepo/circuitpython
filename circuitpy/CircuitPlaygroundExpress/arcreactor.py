...
import time
#import urandom
import random #CP 2.1.* 2017-1021 PePo deprecated: urandom

import board
import analogio #2017-1021 PePo deprecated: nativeio
...
OUTER_COUNT  = 24 #PEPo 2017-1021 changed: 24          # Number of neopixles in outer ring.
